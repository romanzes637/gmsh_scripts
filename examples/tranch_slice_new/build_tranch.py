...
def rebuild_t_edz(length: float, quality: float) -> float:
    ...
    t_edz["data"]["matrix"][1][2] = str(5.3) + str(";") + str(quality)
    t_edz["data"]["matrix"][1][3] = str(5.6) + str(";") + str(quality)


    t_edz["data"]["matrix"][2][0] = str(0) + str(";") + str(quality)
    t_edz["data"]["matrix"][2][1] = str(6) + str(";") + str(quality)
    t_edz["data"]["matrix"][2][2] = str(6.3) + str(";") + str(quality)
    ...
    t_edz_basic["data"]["matrix"][1][2] = str(5.3) + str(";") + str(quality)
    t_edz_basic["data"]["matrix"][1][3] = str(5.6) + str(";") + str(quality)

    t_edz_basic["data"]["matrix"][2][0] = str(0) + str(";") + str(quality)
    t_edz_basic["data"]["matrix"][2][1] = str(6) + str(";") + str(quality)
    t_edz_basic["data"]["matrix"][2][2] = str(6.3) + str(";") + str(quality)
    ...
    t_edz_right["data"]["matrix"][1][1] = str(5.6) + str(";") + str(quality)

    t_edz_right["data"]["matrix"][2][0] = str(0) + str(";") + str(quality)
    t_edz_right["data"]["matrix"][2][1] = str(6.3) + str(";") + str(quality)
    ...
    t_edz_left["data"]["matrix"][1][1] = str(5.6) + str(";") + str(quality)

    t_edz_left["data"]["matrix"][2][0] = str(0) + str(";") + str(quality)
    t_edz_left["data"]["matrix"][2][1] = str(6.3) + str(";") + str(quality)
...
def resizing_buffer(buff: float, quality: float) -> float:
    ...
    data_loaded["data"]["matrix"][0][2] = str(2.8 + buff) + str(";") + str(quality)
    data_loaded["data"]["matrix"][0][3] = str(2.8 + 2 * buff) + str(";") + str(quality)

    data_loaded["data"]["matrix"][1][0] = str(0) + str(";") + str(quality)
    data_loaded["data"]["matrix"][1][1] = str(2.8) + str(";") + str(quality)

    data_loaded["data"]["matrix"][2][0] = str(0) + str(";") + str(quality)
    data_loaded["data"]["matrix"][2][1] = str(5.0) + str(";") + str(quality)
    block_length = 2.8 + 2 * buff
    with open('R_bent_sides.yaml', 'w') as outfile:
        yaml.dump(data_loaded, outfile)
    #end R_bent_sides.yaml
    return block_length

def resizing_tranches(n_RAO: int, block_length: float, quality: float) -> float:
    '''length of tranches'''\
    #R_edz.yaml
    ...
    r_edz["data"]["matrix"][1][2] = str(3.1) + str(";") + str(quality)
    r_edz["data"]["matrix"][1][3] = str(3.4) + str(";") + str(quality)
    ...
    r_edz_left["data"]["matrix"][1][1] = str(3.4) + str(";") + str(quality)
    ...
    r_edz_right["data"]["matrix"][1][1] = str(3.4) + str(";") + str(quality)
    ...
    r_edz_trunch["data"]["matrix"][1][1] = str(3.4) + str(";") + str(quality)
    ...
    plug_tranch["data"]["matrix"][1][1] = str(5.6) + str(";") + str(quality)
    ...
    with open('RW_concrete_bent.yaml') as f:
    ...
    RW_concrete_bent["data"]["layer"][0][2] = str(0.9) + str(";") + str(quality)
    RW_concrete_bent["data"]["layer"][0][3] = str(1.4) + str(";") + str(quality)

    RW_concrete_bent["data"]["layer"][1][0] = str(0.5) + str(";") + str(quality)
    RW_concrete_bent["data"]["layer"][1][1] = str(0.6) + str(";") + str(quality)
    RW_concrete_bent["data"]["layer"][1][2] = str(3.96) + str(";") + str(quality)
    RW_concrete_bent["data"]["layer"][1][3] = str(4.5) + str(";") + str(quality)
    RW_concrete_bent["data"]["layer"][1][4] = str(5) + str(";") + str(quality)

    with open('RW_concrete_bent.yaml', 'w') as outfile:
        yaml.dump(RW_concrete_bent, outfile)
    # end RW_concrete_bent.yaml



    return tranch_length
...
#def resize_result(env_X: float, env_Y: float, env_Z: float, tranch: float, env_quality: float):
    ...
    result["data"]["matrix"][2][1] = str(env_Z_bottom + env_Z_top + 0.6 + 6.3 + 5.3) + str(";") + str(env_quality)
    ...
    #print(result["data"]["items_children_transforms"][1][0][0][0])


    # shifting tranch inside env
    # X
    #print(result["data"]["items_children_transforms"][0][0][0][0])
    result["data"]["items_children_transforms"][0][0][0][0] = 0 - tranch / 2
    # Y
    #print(result["data"]["items_children_transforms"][0][0][0][1])
    result["data"]["items_children_transforms"][0][0][0][1] = 0 - 5.6 / 2
    # Z
    ...
    if env_Z_bottom < env_Z_top:
        ...
        shift = delta_z_top
    #print(result["data"]["items_children_transforms"][0][0][0][2])
...
if __name__ == "__main__":
    ...
    env_X = float(sys.argv[4])
    env_Y = float(sys.argv[5])
    env_Z_bottom = float(sys.argv[6])
    env_Z_top = float(sys.argv[7])
    quality_env = float(sys.argv[8])
    #env_Z = float(sys.argv[6])
    #quality_env = float(sys.argv[7])
    block = resizing_buffer(buff_size, quality_rao)
    tranch = resizing_tranches(n_of_rao, block, quality_rao)
