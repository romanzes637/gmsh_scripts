...
def resizing_buffer(buff: float, quality: float) -> float:
    ...
    data_loaded["data"]["matrix"][0][2] = str(3.6 + buff) + str(";") + str(quality)
    data_loaded["data"]["matrix"][0][3] = str(3.6 + 2 * buff) + str(";") + str(quality)
    #Y
    ...
    block_length = 3.6 + 2 * buff# 3.6 via X
...
def resizing_tranches(n_RAO: int, block_length: float, quality: float) -> float:
    ...
    RW_concrete_bent["data"]["layer"][0][2] = str(1.4) + str(";") + str(quality)
    RW_concrete_bent["data"]["layer"][0][3] = str(1.8) + str(";") + str(quality)
    #Y
